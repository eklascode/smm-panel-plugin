            ...
            <div class="col-md-5">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h3 class="card-title text-uppercase"><?php echo lang("uddoktapay_confirm_form"); ?></h3>
                    </div>
                    <div class="card-body">
                        <div class="tab-content">
                            <form method="post" action="<?php echo cn($module . "/uddoktapay/create_payment"); ?>">
                                ...
                                <div class="form-group">
                                    <p class="text-info"><?php echo lang("note"); ?> <?php echo lang('uddoktapay_confirm_form_note'); ?></p>
                                </div>
